...
Ad.create(user_id: 4, type_id: 1, state: 'published', title: 'BTC', body: '101 BTC per 3600 USDT')
...
Ad.create(user_id: 4, type_id: 1, state: 'published', title: 'BTC', body: '5 BTC per 3530 USDT')
Ad.create(user_id: 2, type_id: 2, state: 'published', title: 'BTC', body: '9 BTC per 3520 USDT')
Ad.create(user_id: 4, type_id: 3, state: 'published', title: 'BTC', body: '2 BTC per 3550 USDT')
Ad.create(user_id: 2, type_id: 1, state: 'published', title: 'BTC', body: '11 BTC per 3510 USDT')
Ad.create(user_id: 4, type_id: 2, state: 'published', title: 'BTC', body: '55 BTC per 3400 USDT')
