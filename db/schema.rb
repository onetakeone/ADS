...
ActiveRecord::Schema.define(version: 20_171_025_112_316) do
  ...
  create_table 'ads', force: :cascade do |t|
    ...
    t.index "to_tsvector('english'::regconfig, (((title)::text || ' '::text) || body))", name: 'ads_idx', using: :gin
    t.index ['body'], name: 'index_ads_on_body'
